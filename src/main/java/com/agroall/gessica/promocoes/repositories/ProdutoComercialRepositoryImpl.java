...
public class ProdutoComercialRepositoryImpl implements Repository {
	...
	public <ProdutoComercial> ProdutoComercial findById_(Object id) {
		com.agroall.gessica.promocoes.dataobjects.ProdutoComercial result = mongo.findById(id, com.agroall.gessica.promocoes.dataobjects.ProdutoComercial.class);
	...
	public <ProdutoComercial> Collection<ProdutoComercial> listAll_() {
		List<com.agroall.gessica.promocoes.dataobjects.ProdutoComercial> result = mongo.findAll(com.agroall.gessica.promocoes.dataobjects.ProdutoComercial.class);
