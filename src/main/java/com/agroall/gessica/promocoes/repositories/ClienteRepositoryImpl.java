...
public class ClienteRepositoryImpl implements Repository {
	...
	public <Cliente> Cliente findById_(Object id) {
		com.agroall.gessica.promocoes.dataobjects.Cliente result = mongo.findById(id, com.agroall.gessica.promocoes.dataobjects.Cliente.class);
	...
	public <Cliente> Collection<Cliente> listAll_() {
		List<com.agroall.gessica.promocoes.dataobjects.Cliente> result = mongo.findAll(com.agroall.gessica.promocoes.dataobjects.Cliente.class);
